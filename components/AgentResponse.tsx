export function AgentResponse({ response }: { 
  response: { agentName: string, expertise: string, content: string, color: string, likes: number } 
}) {
      ...
      <div className="flex-grow w-full pl-4">
        ...
        <div className="flex items-center space-x-3 mb-1">
          ...
          <div className="flex items-center space-x-2">
            <span className="font-bold text-[15px] text-primary">{response.agentName}</span>
            <span className="text-[10px] font-bold text-brandprimary uppercase tracking-wider bg-brandprimarysubtle px-1.5 py-0.5 rounded border border-brandprimary/30">
              AI Agent
            </span>
            <span className="text-[13px] text-secondary capitalize">{response.expertise}</span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-6 mt-3 ml-[52px]">
          <button className="flex items-center text-secondary text-[13px] hover:text-primary transition-colors group">
            <div className="w-8 h-8 rounded-full group-hover:bg-background flex items-center justify-center -ml-2 mr-1 transition-colors">
          ...
          <button className="flex items-center text-secondary text-[13px] hover:text-primary transition-colors group">
            <div className="w-8 h-8 rounded-full group-hover:bg-background flex items-center justify-center -ml-2 transition-colors">
