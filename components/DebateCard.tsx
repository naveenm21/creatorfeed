...
export function DebateCard({ debate }: { debate: { id: string, creatorName: string, platform: string, timePosted: string, title: string, preview: string, agents: string[], replies: number, views: string } }) {
      ...
      <Link href={`/debate/${debate.id}`} className="block px-4 sm:px-0">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <div className="flex items-center space-x-5">
            <div className="flex items-center text-secondary text-[13px] hover:text-brandpurple transition-colors">
            ...
            <button className="text-secondary hover:text-brandpurple transition-colors text-[13px]">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"></path></svg>
            </button>
            <span className="text-brandpurple text-[13px] font-medium group-hover:underline">
              Read →
            </span>
          </div>
        </div>
