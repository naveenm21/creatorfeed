      ...
      <div className="w-full max-w-[400px]">
        <div className="bg-card border border-borderdefault 
          ...
          <button
            ...
            className="w-full flex justify-center py-3 px-4 border border-borderdefault rounded-xl shadow-[var(--raise-shadow)] text-sm font-medium text-primary bg-card hover:bg-cardhover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brandprimary transition-all active:scale-[0.98] mb-4 disabled:opacity-70"
          >
